...
def determine_flip_flop_suitability(weather_data: dict) -> str:
    ...
    Based on this weather data, determine if it is okay to wear flip-flops today. Consider the temperature, precipitation, and any other relevant conditions in your response.  If flip-flops are not appropriate, make another footwear suggestion based on the weather.
    """

    # Call GPT
    openai.api_key = "Open Ai Key"  # Load API key from environment variable
